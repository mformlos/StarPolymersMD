...
#paramSets=[ParamSetMixed([Type(28,12)],[6,9,15],5,[0.5,0.8,1.05,1.15],0.4, [Size(160, 160, 160)], 0.001, 1E7, 5E8, 1E3,[MPC("No", [0.0])],"pdb", 1E5, "No",1E6)] 
#paramSets.append([ParamSetMixed([Type(28,12)],[6,9,15],5,[0.5, 0.8, 1.05, 1.15],0.5, [Size(50, 50, 50)], 0.001, 1E7, 5E8, 1E4, [MPC("MPC", [0.0])],"pdb", 1E5, "No",1E6)]) 
paramSets.append([ParamSetMixed([Type(28,12)],[6,9,15],5,[0.5,0.8, 1.05, 1.15],0.5, [Size(50, 50, 50)], 0.001, 1E5, 5E8, 1E4, [MPC("MPC", [0.00001,0.00002, 0.0001, 0.0002])],"pdb", 1E5, "No",1E6)])
#paramSets.append([ParamSetMixed([Type(28,12)],[6,9,15],5,[0.5, 0.8, 1.05, 1.15],0.5, [Size(80, 50, 50)], 0.001, 1E5, 5E8, 1E4, [MPC("MPC", [0.0005, 0.001, 0.002, 0.005])],"pdb", 1E5, "No",1E6)])
#paramSets.append([ParamSetMixed([Type(28,12)],[6,9,15],5,[0.5, 0.8, 1.05, 1.15],0.5, [Size(100, 50, 50)], 0.001, 1E5, 5E8, 1E4, [MPC("MPC", [0.01,0.02])],"pdb", 1E5, "No",1E6)])
